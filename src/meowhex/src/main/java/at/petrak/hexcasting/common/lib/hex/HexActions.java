...
public class HexActions {
    ...
    public static final ActionRegistryEntry TRANSFER_TO_DEPOT = make("transfer_to_depot",
        new ActionRegistryEntry(HexPattern.fromAngles("aawaqde", HexDir.EAST), OpTransferToDepot.INSTANCE));
