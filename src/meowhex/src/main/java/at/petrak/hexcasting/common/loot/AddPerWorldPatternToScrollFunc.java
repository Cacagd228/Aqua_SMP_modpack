 ...
 * <p>
 * The behavior {@link AddPerWorldPatternToScrollFunc#doStatic}
 * is used for loot table integration.
 */
public class AddPerWorldPatternToScrollFunc extends LootItemConditionalFunction {
    ...
    public static ItemStack doStatic(ItemStack stack, LootContext ctx) {
        ...
        NBTHelper.putString(stack, ItemScroll.TAG_OP_ID, key.location().toString());
        NBTHelper.putCompound(stack, ItemScroll.TAG_PATTERN, pat.serializeToNBT());
