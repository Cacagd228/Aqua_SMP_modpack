...
public class ItemSpellbook extends Item implements IotaHolderItem, VariantItem {
    ...
    @Override
    public void appendHoverText(ItemStack stack, TooltipContext level, List<Component> tooltip,
    ...
    public void inventoryTick(ItemStack stack, Level pLevel, Entity pEntity, int pSlotId, boolean pIsSelected) {
        ...
        if (stack.has(DataComponents.CUSTOM_NAME)) {
            names.putString(nameKey, Component.Serializer.toJson(stack.getHoverName(), RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY)));
        } else {
    ...
    public static int rotatePageIdx(ItemStack stack, boolean increase) {
        ...
        if (name != null) {
            stack.set(DataComponents.CUSTOM_NAME, Component.Serializer.fromJson(name, RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY)));
        } else {
