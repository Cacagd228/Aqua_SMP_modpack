...
public class EntityIota extends Iota {
    ...
    Tag serialize() {
        ...
        out.putString("name", Component.Serializer.toJson(this.getEntity().getName(), BUILTIN_REGISTRY_ACCESS));
        return out;
    }
    ...
    public static IotaType<EntityIota> TYPE = new IotaType<>() {
        ...
        public Component display(Tag tag) {
            ...
            var component = Component.Serializer.fromJsonLenient(nameJson, BUILTIN_REGISTRY_ACCESS);
            return (component == null ? Component.translatable("hexcasting.spelldata.entity.whoknows") : component)
