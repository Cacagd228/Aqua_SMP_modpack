...
object OpPlaceBlock : SpellAction {
    ...
    override fun execute(
        ...
        val itemUseCtx = env
            ...
            ?.stack?.let { PublicUseOnContext(env.world, env.caster, env.castingHand, it, blockHit) }
        ...
        override fun cast(env: CastingEnvironment) {
            ...
            if (placeeStack != null) {
                ...
                if (!placeeStack.isEmpty) {
                    ...
                    val itemUseCtx = PublicUseOnContext(env.world, caster, env.castingHand, spoofedStack, blockHit)
                    val placeContext = BlockPlaceContext(itemUseCtx)
