...
public class HexLootFunctions {
    ...
    public static final LootItemFunctionType<AddPerWorldPatternToScrollFunc> PATTERN_SCROLL = register("pattern_scroll",
        new LootItemFunctionType<>(AddPerWorldPatternToScrollFunc.CODEC));
    public static final LootItemFunctionType<AmethystReducerFunc> AMETHYST_SHARD_REDUCER = register("amethyst_shard_reducer",
