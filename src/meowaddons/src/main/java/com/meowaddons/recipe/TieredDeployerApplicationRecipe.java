...
public class TieredDeployerApplicationRecipe extends DeployerApplicationRecipe implements TieredRecipe {
	...
	@Override public void addRequiredMachines(Set<net.minecraft.world.level.ItemLike> machines){ machines.add(TieredAssemblySteps.deployerMachine(tier)); }
	@Override public Supplier<Supplier<SequencedAssemblySubCategory>> getJEISubCategory(){ return TieredAssemblySteps.deploying(tier); }
